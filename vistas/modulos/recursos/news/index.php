...
if (isset($_POST['buscar'])) {
    ...
    $datos_mensaje = $instancia->mostrarMensajesLimitesControl();
}
        ...
        <div class="col-lg-12">
            <div class="card shadow-sm mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    ...
                    <div class="btn-group">
                        <a href="<?=BASE_URL?>recursos/news/mensaje" class="btn btn-secondary btn-sm">
                            <i class="fas fa-comment"></i>
                            &nbsp;
                            Mensaje General
                        </a>
                        <button class="btn btn-play btn-sm" type="button" data-toggle="modal" data-target="#agregar_mensaje">
                        ...
                        <table class="table table-hover border table-sm" width="100%" cellspacing="0">
                            <thead>
                                <tr class="text-center font-weight-bold">
                                    ...
                                    <th scope="col">Nivel del mensaje</th>
...
include_once VISTA_PATH . 'modulos' . DS . 'recursos' . DS . 'news' . DS . 'agregarMensajeProgramado.php';

if (isset($_POST['fecha_programa'])) {
    $instancia->mensajeAsistenciaControl();
}