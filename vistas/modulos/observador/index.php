...
if (isset($_POST['buscar'])) {
	...
	$datos_usuarios = $instancia_usuario->mostrarEstudiantesControl();
}
									...
									<tr class="text-center user_<?=$id_user?>">
										...
										<td>
											<div class="btn-group" role="group">
												<a href="<?=BASE_URL?>observador/historial?estudiante=<?=base64_encode($id_user)?>" class="btn btn-play btn-sm" data-tooltip="tooltip" title="Historial Observador" data-placement="bottom">
													<i class="fa fa-eye"></i>
												</a>
