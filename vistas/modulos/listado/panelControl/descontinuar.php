            ...
            <div class="card shadow-sm mb-4">
                <div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
                    <h4 class="m-0 font-weight-bold text-primary">
                        ...
                        &nbsp;
                        Panel de control - Descontinuar (<?= $info_inventario['descripcion'] . ' - ' . $info_inventario['id'] ?>)
                    </h4>
                </div>
                <div class="card-body">
                    <form method="POST">
                        <div class="col-lg-12">
                            <div class="row">
                                ...
                                <div class="form-group col-lg-4">
                                    <label for="fecha" class="font-weight-bold">Fecha Descontinuado <span class="text-danger">*</span> </label>
                        ...
                        <div class="col-lg-12 text-right">
                            ...
                            <input type="hidden" value="<?= $info_inventario['id_user'] ?>" name="id_user_desc">
                            <input type="hidden" value="<?= $info_inventario['id_area'] ?>" name="id_area_desc">
                            <input type="hidden" value="<?= $id_inventario ?>" name="id_inventario_desc">
                            <input type="hidden" value="<?= $info_inventario['descripcion'] ?>" name="nom_inventario_desc">
                            <input type="hidden" value="<?= $id_super_empresa ?>" name="super_empresa_desc">
                            <input type="hidden" value="1" name="inicio">
                            <button class="btn btn-warning btn-sm" type="submit" name="descontinuar" onclick="return confirm('¿Está seguro de descontinuar <?= $info_inventario['descripcion'] ?>?')">
