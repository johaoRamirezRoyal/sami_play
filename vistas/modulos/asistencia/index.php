        ...
        <div class="col-lg-12">
            <div class="card shadow-sm mb-4">
                ...
                <div class="col-lg-12 form-group mt-2 text-right <?=$descargar_reporte?>">
                    <a href="<?=BASE_URL?>imprimir/recursos/ReporteAsistencia?buscar=<?=$_POST['buscar']?>&perfil=<?=$_POST['perfil']?>&fecha=<?=$_POST['fecha']?>" target="_blank" class="btn btn-success btn-sm">
