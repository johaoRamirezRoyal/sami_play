				...
				<div class="card shadow-sm mb-4">
					<div class="card-header py-3 d-flex flex-row align-items-center justify-content-between">
						<h4 class="m-0 font-weight-bold text-play">
							<a href="<?=BASE_URL?>calificacion/index" class="text-decoration-none text-play">
								<i class="fa fa-arrow-left"></i>
							</a>
							&nbsp;
							Calificaciones - Estudiante  (<?=$datos_estudiante['nombre'] . ' ' . $datos_estudiante['apellido']?>)
						</h4>
					</div>
					<div class="card-body">
						<form method="POST">
							...
							<input type="hidden" name="url" value="notas">
							<div class="row p-2">
								...
								<div class="col-lg-12 form-group text-left mt-4">
									...
									<ul class="ml-4">
										<li>LA: Logro alcanzado satisfactoriamente</li>
										<li>LD: Logro en proceso de desarrollo</li>
										<li>NA: Necesita apoyo del adulto para culminar con éxito su tarea.</li>
									</ul>
								</div>
							</div>
									...
									foreach ($datos_dimensiones as $dimension) {
										...
										<tbody class="buscar">
											...
											foreach ($datos_indicadores as $indicador) {
												...
												$check_3 = (!empty($notas_guardadas['indicador']) && $notas_guardadas['nota'] == 3) ? 'checked' : '';
												...
												if ($nom_indicador != '') {
													...
													<tr class="text-left">
														...
														<td>
															<div class="form-check">
																<input class="form-check-input" type="radio" name="nota_<?=$id_indicador?>" value="3" <?=$check_3?>>
															</div>
														</td>
													</tr>
												<?php }}?>
