        ...
        <div class="modal-content">
            <form method="POST">
                ...
                <div class="modal-header p-3">
                    <h4 class="modal-title text-success font-weight-bold">Agregar Registro de Cortesía</h4>
                </div>
                ...
                <div class="modal-body border-0">
                    <div class="row p-3">
                        ...
                        <div class="col-lg-6 form-group">
                            ...
                            <input type="number" name="visitante" class="form-control" id="cantidad" placeholder="Ingrese la cantidad de visitantes a cargo del acudiente" required>
                        </div>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        function calcularHoraSalidaCortesia() {
            ...
            if (horaIngreso && !isNaN(duracion)) {
                var minutosDuracion = (duracion === 1) ? 30 : 60;
